...
class userOperations {
    ...
    static adminUserInvite = async (req: Request, res: Response) => {
        ...
        try {
            ...
            const emailOptions = {
                ...
                html: `<p>Hello ${firstName},</p><p>Welcome to our platform! Your account has been created successfully, please complete your details in this form <a></a></p><p>Best Regards,<br>Team</p>`,
            };
    ...
    static newUser = async (req: Request, res: Response) => {
        const { firstName, lastName, email, role,phoneNumber, password, groupId, groupName } = req.body;
